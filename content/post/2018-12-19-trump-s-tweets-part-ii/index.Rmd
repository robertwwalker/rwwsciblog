...
A cool post on sentiment analysis can be found [here](http://dataaspirant.com/2018/03/22/twitter-sentiment-analysis-using-r/).  I will now get at the time series characteristics of his tweets and the sentiment stuff.  This plays off of a previous post.

I start by loading the tmls object that I created [in the previous post](https://rww.science/post/trump-tweet-word-clouds/).  To capture constant content over time, there I describe how to download and break up the timeline.
